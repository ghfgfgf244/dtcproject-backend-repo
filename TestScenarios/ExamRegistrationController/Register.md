# Test Scenarios: ExamRegistrationController.Register

## UTC_ExamRegistrationController_Register_01 - Positive
**Objective:** Verify that user can successfully Register.

### Steps:
1. Navigate to the Register interface.
2. Input valid required data for Register.
...
## UTC_ExamRegistrationController_Register_02 - Negative
**Objective:** Verify system behavior when mandatory fields for Register are missing.
...
## UTC_ExamRegistrationController_Register_03 - Negative
...
## UTC_ExamRegistrationController_Register_04 - Security
**Objective:** Verify that unauthorized users cannot Register.
